...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PC5     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = LED_STRIP_1_TX_Pin|GPIO_PIN_5;
  ...
  */
    ...
    PB2     ------> USART3_TX
    */
    GPIO_InitStruct.Pin = GPIO_PIN_0|LED_STRIP_2_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PC5     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOC, LED_STRIP_1_TX_Pin|GPIO_PIN_5);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB2     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0|LED_STRIP_2_TX_Pin);
