...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PC4     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = LED_STRIP_1_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_USART1;
    HAL_GPIO_Init(LED_STRIP_1_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB2     ------> USART3_TX
    */
    GPIO_InitStruct.Pin = LED_STRIP_2_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_USART3;
    HAL_GPIO_Init(LED_STRIP_2_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END USART4_MspInit 0 */
    ...
    PA0     ------> USART4_TX
    */
    GPIO_InitStruct.Pin = LED_STRIP_3_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_USART4;
    HAL_GPIO_Init(LED_STRIP_3_TX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PC4     ------> USART1_TX
    */
    HAL_GPIO_DeInit(LED_STRIP_1_TX_GPIO_Port, LED_STRIP_1_TX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB2     ------> USART3_TX
    */
    HAL_GPIO_DeInit(LED_STRIP_2_TX_GPIO_Port, LED_STRIP_2_TX_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PA0     ------> USART4_TX
    */
    HAL_GPIO_DeInit(LED_STRIP_3_TX_GPIO_Port, LED_STRIP_3_TX_Pin);
